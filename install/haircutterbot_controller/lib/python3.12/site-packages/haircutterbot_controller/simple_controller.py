...
#def timer_callback(self):
   #     msg = String()
    ...
    def joyCallback(self, msg):
        ...
        # arm_state = RobotState(self.haircutterbot.get_robot_model())
        # gripper_state = RobotState(self.haircutterbot.get_robot_model())
        ...
        # self.haircutterbot_arm.set_start_state_to_current_state()
        # self.haircutterbot_gripper.set_start_state_to_current_state()

        # self.haircutterbot_arm.set_goal_state(robot_state=arm_state)
        # self.haircutterbot_gripper.set_goal_state(robot_state=gripper_state)

        # arm_plan_result = self.haircutterbot_arm.plan()
        # gripper_plan_result = self.haircutterbot_gripper.plan()

        # if arm_plan_result and gripper_plan_result:
        #     self.get_logger().info("Planner SUCCEED, moving the arm and the gripper")
        #     self.haircutterbot.execute(arm_plan_result.trajectory, controllers=[])
        #     self.haircutterbot.execute(gripper_plan_result.trajectory, controllers=[])
        # else:
